<%-- 
    Document   : Form2.jsp
    Created on : May 23, 2017, 8:45:53 PM
    Author     : ahdmuhajir
--%>
...
<option value="LGS" selected="selected">Pidie Jaya</option>         
</select></td>    
</tr>    
<tr>      
<td>Pekerjaan</td>      
<td><input name="pekerjaan" type="radio" value="mahasiswa" 
checked="checked" /> Mahasiswa<br>   
