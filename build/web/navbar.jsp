<%-- 
    Document   : navbar.jsp
    Created on : May 22, 2017, 9:06:39 PM
    Author     : ahdmuhajir
--%>
...
<html>
    ...
    <body>
        ...
        <table width="439" border="0" bgcolor="#0000FF">	
            <tr>			
                <td	width="91"	bgcolor="<%=latarhome%>"	class="style1"><div
                        align="center"	class="style1"><strong><a
                                href="indexMenu.jsp?link=home">Home</a></strong></div></td>
                <td	width="83"	bgcolor="<%=latarproduk%>"	class="style1"><div
                        align="center"		class="style2"><a
                            href="TagMenu.jsp?link=produk">Produk</a></div></td>	
                <td	width="101"	bgcolor="<%=latarkontak%>"	class="style1"><div
                        align="center"		class="style2"><a
                            href="TagMenu.jsp?link=kontak">Kontak</a></div></td>	
                <td	width="136"	bgcolor="<%=latartentang%>"	class="style1"><div
                        align="center" class="style2"><a href="TagMenu.jsp?link=tentang">Tentang Kami</a> </div></td>
